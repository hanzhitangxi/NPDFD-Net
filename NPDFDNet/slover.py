...
from NPDFDNet.HDDCA import NPDFDNet
...
class NPDFD_Trainer(object):
    def __init__(self, config, training_loader,testing_loader):
        super(NPDFD_Trainer, self).__init__()
    ...
    def build_model(self):
        self.model = NPDFDNet(base_filter=self.sampling_point).to(self.device)
