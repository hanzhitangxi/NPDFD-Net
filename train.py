...
from NPDFDNet.slover import NPDFD_Trainer

# set Training parameter
parser = argparse.ArgumentParser(description='NPDFD')
...
parser.add_argument('--nEpochs', type=int, default=80, help='Iterations')
...
parser.add_argument('--samplingPoint', type=int, default=102, help='1% - 10 4% - 41 10% - 102 25% - 256 30% - 307 40% - 410 50% - 512')
...
parser.add_argument('--resume_dir', type=str, default="./model/model_path.pth")
...
train_dataset = DatasetFromHdf5("train0.h5")
...
# saved_model select
model = NPDFD_Trainer(args, train_loader, val_loader)
#model = HDDCA_Trainer(args, train_loader)
